...
void testFloatsAlmostEqual(void)
{
#ifdef UNITY_EXCLUDE_FLOAT
    TEST_IGNORE();
#else
    //TEST_ASSERT_NOT_EQUAL_FLOAT(9273.9649f, 9273.0049f);
    TEST_ASSERT_ALMOST_EQUAL_FLOAT(18.72450f, 18.72460f, 1);
    TEST_ASSERT_ALMOST_EQUAL_FLOAT(18.72450f, 18.72460f, 2);
	TEST_ASSERT_ALMOST_EQUAL_FLOAT(18.72450f, 18.72460f, 3);
	TEST_ASSERT_ALMOST_EQUAL_FLOAT(18.72450f, 18.72460f, 0);

	TEST_ASSERT_ALMOST_EQUAL_FLOAT(-726.93724f, -726.93724f, 1);
	TEST_ASSERT_ALMOST_EQUAL_FLOAT(-726.93724f, -726.93724f, 2);
	TEST_ASSERT_ALMOST_EQUAL_FLOAT(-726.93724f, -726.93724f, 3);
	TEST_ASSERT_ALMOST_EQUAL_FLOAT(-726.93724f, -726.93724f, 0);

	TEST_ASSERT_ALMOST_EQUAL_FLOAT_MESSAGE(18.72450f, 18.72460f, 0, "Some cool message here");

    EXPECT_ABORT_BEGIN
	TEST_ASSERT_ALMOST_EQUAL_FLOAT(18.00450f, 18.72460f, 2);
    TEST_ASSERT_ALMOST_EQUAL_FLOAT_MESSAGE(18.7012f, 18.72460f, 2, "Some cool message here");
    VERIFY_FAILS_END
#endif
}

void testFloatsAlmostEqual_2(void)
{
#ifdef UNITY_EXCLUDE_FLOAT
    TEST_IGNORE();
#else
    //TEST_ASSERT_NOT_EQUAL_FLOAT(9273.9649f, 9273.0049f);
    TEST_ASSERT_ALMOST_EQUAL_FLOAT_2(18.72450f, 18.72460f, 1);
    TEST_ASSERT_ALMOST_EQUAL_FLOAT_2(18.72450f, 18.72460f, 2);
	TEST_ASSERT_ALMOST_EQUAL_FLOAT_2(18.72450f, 18.72460f, 3);
	TEST_ASSERT_ALMOST_EQUAL_FLOAT_2(18.72450f, 18.72460f, 0);

	TEST_ASSERT_ALMOST_EQUAL_FLOAT_2(-726.93724f, -726.93724f, 1);
	TEST_ASSERT_ALMOST_EQUAL_FLOAT_2(-726.93724f, -726.93724f, 2);
	TEST_ASSERT_ALMOST_EQUAL_FLOAT_2(-726.93724f, -726.93724f, 3);
	TEST_ASSERT_ALMOST_EQUAL_FLOAT_2(-726.93724f, -726.93724f, 0);

	//TEST_ASSERT_ALMOST_EQUAL_FLOAT_MESSAGE(18.72450f, 18.72460f, 0, "Some cool message here");

    EXPECT_ABORT_BEGIN
	TEST_ASSERT_ALMOST_EQUAL_FLOAT_2(18.00450f, 18.72460f, 2);
    //TEST_ASSERT_ALMOST_EQUAL_FLOAT_MESSAGE(18.7012f, 18.72460f, 2, "Some cool message here");
    VERIFY_FAILS_END
#endif
}
